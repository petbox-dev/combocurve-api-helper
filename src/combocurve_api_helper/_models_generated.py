...
class _GeneratedModelMethods(_EconModelMethodsBase):
    ...
    def get_general_options_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_general_options_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_actual_forecast_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_actual_forecast_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_capex_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_capex_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_date_settings_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_date_settings_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_depreciation_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_depreciation_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_differentials_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_differentials_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_emissions_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_emissions_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_escalations_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_escalations_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_expenses_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_expenses_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_fluid_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_fluid_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_operations_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_operations_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_ownership_reversions_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_ownership_reversions_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_pricing_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_pricing_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_production_taxes_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_production_taxes_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_reserves_categories_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_reserves_categories_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_riskings_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_riskings_model_by_id(self, project_id: str, model_id: str) -> Item | None:
    ...
    def get_stream_properties_models_url(self, project_id: str, filters: dict[str, str] | None = None) -> str:
    ...
    def get_stream_properties_model_by_id(self, project_id: str, model_id: str) -> Item | None:
